...
strings = {
    ...
    'ip_address': 'Die IP-Adresse ist für ihren Rechner eindeutig und kann zwei verschiedene Formate haben',
    ...
    'next': 'Weiter',
    'confirm_config': 'Softwarekomponenten',
