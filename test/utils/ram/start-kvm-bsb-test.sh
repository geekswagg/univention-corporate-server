...
export BSB_PACKAGE_SCOPE="${BSB_PACKAGE_SCOPE:=fhh-bsb-iam-dev-intern}"

# user specific instances "username_..."
export KVM_OWNER="${BUILD_USER_ID:=$USER}"
export JOB_BASE_NAME="${JOB_BASE_NAME:=bsb-test-env}"

exec ./utils/start-test.sh scenarios/autotest-249-bsb-test.cfg
