...
COMMON_EXCEPTIONS = (
    ...
    E("ModuleNotFoundError: No module named 'shlex'", ['univention-config-registry']),
    ...
    E(r"noLock\: .*The attribute \'sid\' could not get locked\.", ['in __allocate_rid'], 58399),
    E(r'univention.admin.uexceptions.sidAlreadyUsed: The relative ID \(SAMBA\) is already in use:', ['in sync_to_ucs'], 58399),
